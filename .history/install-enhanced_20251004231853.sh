...
interactive_menu() {
    ...
    while true; do
        ...
        echo -e "  7) Secure Port: $SECURE_PORT"
        echo ""
        echo -e "${YELLOW}Options:${NC}"
        echo -e "  ${GREEN}s)${NC} Start Installation"
        echo -e "  ${GREEN}1-7)${NC} Modify Configuration"
...
install_phynx() {
    ...
    # Security setup
    show_step_header 9 "Security Configuration"
    ...
    # Final configuration
    show_step_header 9 "Final Configuration"
    ...
    show_step_header 10 "System Optimization"
